...
fn test_mock_prove() {
    ...
    let l1_block_range_hash = Some(H256("0x3c8e0460c773f86d9170137735eebb0efdb8336362fe98ff0b4b82dd8dff274d".as_bytes().try_into().expect("err")));
    println!("l1_block_range_hash: {:?}", l1_block_range_hash)
    ...
    Prover::<SuperCircuit>::mock_prove_target_circuit_batch(ChunkTrace {
        ...
        l1_block_range_hash: l1_block_range_hash.clone(),
    })
    .unwrap();
}
